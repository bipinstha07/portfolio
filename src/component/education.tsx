    ...
    return (
        ...
        {data.map((data,index)=>(
            ...
            <div key={index}  className="flex items-center justify-center gap-10  p-4 ">
                    <motion.img whileInView={{ x: 0, opacity: 1 }} initial={{ opacity: 0, x: -100 }} transition={{ duration: 0.5 }}  width="120px" src={data.img} alt="ULM Logo" className="" />
                    <motion.div whileInView={{ x: 0, opacity: 1 }} initial={{ opacity: 0, x: -100 }} transition={{ duration: 0.5 }} >
